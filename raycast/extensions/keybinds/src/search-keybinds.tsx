...
const SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { binding: "ctrl-alt-left", description: "Decrease window width" },
      { binding: "ctrl-alt-right", description: "Increase window width" },
      { binding: "ctrl-alt-down", description: "Decrease window height" },
      { binding: "ctrl-alt-up", description: "Increase window height" },
    ],
  },
  {
    platform: "Neovim",
