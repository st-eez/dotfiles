...
const AEROSPACE_SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { binding: "alt-6", description: "Jump to workspace 6 (home/office only)" },
      { binding: "alt-7", description: "Jump to workspace 7 (home/office only)" },
      { binding: "alt-8", description: "Jump to workspace 8 (home/office only)" },
      { binding: "alt-9", description: "Jump to workspace 9 (home/office only)" },
      { binding: "alt-0", description: "Jump to workspace 0 (home/office only)" },
    ],
  },
  {
    platform: "Aerospace",
    ...
    entries: [
      ...
      { binding: "alt-shift-6", description: "Move window to workspace 6 and follow (home/office only)" },
      { binding: "alt-shift-7", description: "Move window to workspace 7 and follow (home/office only)" },
      { binding: "alt-shift-8", description: "Move window to workspace 8 and follow (home/office only)" },
      { binding: "alt-shift-9", description: "Move window to workspace 9 and follow (home/office only)" },
      { binding: "alt-shift-0", description: "Move window to workspace 0 and follow (home/office only)" },
    ],
  },
  {
    platform: "Aerospace",
...
const GHOSTTY_SECTIONS: ShortcutSection[] = [
  {
    ...
    entries: [
      ...
      { binding: "cmd-1", description: "Go to tmux window 1" },
      { binding: "cmd-2", description: "Go to tmux window 2" },
      { binding: "cmd-3", description: "Go to tmux window 3" },
      { binding: "cmd-4", description: "Go to tmux window 4" },
      { binding: "cmd-5", description: "Go to tmux window 5" },
      { binding: "cmd-6", description: "Go to tmux window 6" },
      { binding: "cmd-7", description: "Go to tmux window 7" },
      { binding: "cmd-8", description: "Go to tmux window 8" },
      { binding: "cmd-9", description: "Last tmux window" },
      { binding: "shift-cmd-[", description: "Previous tmux window" },
      { binding: "shift-cmd-]", description: "Next tmux window" },
  ...
  },
  {
    ...
    entries: [
      { binding: "cmd-d", description: "New tmux pane (right)" },
      { binding: "shift-cmd-d", description: "New tmux pane (down)" },
      { binding: "cmd-alt-down", description: "Go to tmux pane down" },
      { binding: "cmd-alt-up", description: "Go to tmux pane up" },
      { binding: "cmd-alt-left", description: "Go to tmux pane left" },
      { binding: "cmd-alt-right", description: "Go to tmux pane right" },
      { binding: "cmd-[", description: "Go to previous tmux pane" },
      { binding: "cmd-]", description: "Go to next tmux pane" },
...
const APPLICATION_SECTIONS: ShortcutSection[] = [
  {
    ...
    entries: [
      ...
      { binding: "alt-shift-c", description: "Google Chrome" },
      { binding: "alt-shift-g", description: "GitHub" },
