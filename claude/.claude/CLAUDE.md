...
- Before writing code, invoke the ponytail skill.
...
- Native subagents you spawn yourself (Claude Code Agent tool, including forks) need no prefix; they already know who spawned them.
