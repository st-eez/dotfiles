...
2. Do the work in this session. Probe before you ask; carry a question into the handback only if no probe could answer it and `~/.steez/repo/principles/authority.md` says it is Steve's.
