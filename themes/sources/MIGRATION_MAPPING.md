...
| Ghostty custom theme file (optional per theme) | `overrides.ghostty_theme.*` | `themes/configs/<theme-id>/<theme-id>.ghostty` | `$HOME/.config/ghostty/themes/<identifiers.ghostty>` (symlink, convention-based for any theme providing the file) | **Generated-owned** when present. Do not hand-edit generated custom theme files in repo. |
...
| OpenCode custom theme file (optional per theme) | `palette.*`, `overrides.opencode_theme.*` | `themes/configs/<theme-id>/<theme-id>.json` | `$HOME/.config/opencode/themes/<theme-id>.json` (symlink, convention-based for any theme providing the file) | **Generated-owned** when present. Do not hand-edit generated JSON in repo. |
