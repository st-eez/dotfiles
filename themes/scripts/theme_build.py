...
def render_btop_theme(theme_source: ThemeSource) -> str:
    ...
    lines = [
        ...
        "",
        "# Mem/Disk used: red -> orange (warm = consumption)",
        f'theme[used_start]="{palette.orange}"',
        f'theme[used_mid]=""',
        f'theme[used_end]="{palette.red}"',
        "",
        "# Mem/Disk available: green -> cyan (cool = headroom)",
        f'theme[available_start]="{palette.green}"',
        f'theme[available_mid]=""',
        f'theme[available_end]="{palette.cyan}"',
        "",
        "# Mem/Disk free: blue -> cyan",
        f'theme[free_start]="{palette.blue}"',
        f'theme[free_mid]=""',
        f'theme[free_end]="{palette.cyan}"',
        "",
